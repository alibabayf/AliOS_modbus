...
static int drv_gyro_bosch_bmg160_set_power_mode(i2c_dev_t *      drv,
...
static int drv_gyro_bosch_bmg160_read(void *buf, size_t len)
{
    ...
    if (current_factor != 0) {
        ...
        gyro->data[DATA_AXIS_X] =
          gyro->data[DATA_AXIS_X] * GYROSCOPE_UNIT_FACTOR / current_factor;
        gyro->data[DATA_AXIS_Y] =
          gyro->data[DATA_AXIS_Y] * GYROSCOPE_UNIT_FACTOR / current_factor;
        gyro->data[DATA_AXIS_Z] =
          gyro->data[DATA_AXIS_Z] * GYROSCOPE_UNIT_FACTOR / current_factor;
    }
