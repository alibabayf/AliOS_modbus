...
const modbus_sensor_t modbus_sensors[] = {
    ...
    { "MTMicrosystems", "MSN1000MB", "noise", dev_noise_path, TAG_DEV_NOISE,
      SENSOR_CLOSE, 0x02, 0x0002, 1, 0, 50 },
    { "MTMicrosystems", "MSP1000MB", "baro", dev_baro_path, TAG_DEV_BARO,
      SENSOR_CLOSE, 0x03, 0x0009, 2, 0, 50 },
    ...
    { "MTMicrosystems", "MSPM25MB", "pm1.0", dev_pm1_path, TAG_DEV_PM1P0,
      SENSOR_CLOSE, 0x05, 0x0006, 1, 0, 50 },
    { "MTMicrosystems", "MSPM25MB", "pm10", dev_pm10_path, TAG_DEV_PM10,
      SENSOR_CLOSE, 0x05, 0x0007, 1, 0, 50 },
    ...
    { "MTMicrosystems", "MSEC10", "ec", dev_ec_path, TAG_DEV_EC,
      SENSOR_CLOSE, 0x04, 0x0002, 1, 0, 50 },
    { "MTMicrosystems", "MSEC10", "salinity", dev_salinity_path, TAG_DEV_SALINITY,
      SENSOR_CLOSE, 0x04, 0x0003, 1, 0, 50 },
    { "MTMicrosystems", "MSEC10", "tds", dev_tds_path, TAG_DEV_TDS,
      SENSOR_CLOSE, 0x04, 0x0004, 1, 0, 50 },
    { "MTMicrosystems", "MLWS10", "leaf  temp", dev_temp_path, TAG_DEV_TEMP,
      SENSOR_CLOSE, 0X05, 0x0000, 1, 0, 50 },
    { "MTMicrosystems", "MLWS10", "leaf  wet", dev_humi_path, TAG_DEV_HUMI,
      SENSOR_CLOSE, 0X05, 0x0001, 1, 0, 50 },
    ...
    { "Honeywell", "HAQEAW", "co2", dev_co2_path, TAG_DEV_CO2, SENSOR_CLOSE,
      0x20, 0x0000, 1, 0, 50 },
    { "Honeywell", "HAQEAW", "humi", dev_humi_path, TAG_DEV_HUMI, SENSOR_CLOSE,
      0x20, 0x0001, 1, 0, 50 },
    { "Honeywell", "HAQEAW", "pm2.5", dev_pm25_path, TAG_DEV_PM25, SENSOR_CLOSE,
      0x20, 0x0002, 1, 0, 50 },
    { "Honeywell", "HAQEAW", "temp", dev_temp_path, TAG_DEV_TEMP, SENSOR_CLOSE,
      0x20, 0x0003, 1, 0, 50 },
    { "Honeywell", "HAQEAW", "tvoc", dev_tvoc_path, TAG_DEV_TVOC, SENSOR_CLOSE,
      0x20, 0x0004, 1, 0, 50 },
    { "Honeywell", "HAQEAW", "hcho", dev_hcho_path, TAG_DEV_HCHO, SENSOR_CLOSE,
      0x20, 0x0005, 1, 0, 50 },
